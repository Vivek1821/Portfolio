...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row items-center text-white m-5 mr-10 mb-10  ">
      <img
        src={vivek}
        alt="Vivek"
        className="hero-image w-60 mb-10 md:h-52 md:w-72 lg:w-80 rounded-full object-cover "
      />
      <div className="about-text max-h-96  bg-gray-900 rounded-lg p-8 mb-10  whitespace-pre-line md:ml-8 text-center md:text-left">
        <h2 className="text-3xl font-bold mb-4">Hi, I'm Vivek!</h2>
